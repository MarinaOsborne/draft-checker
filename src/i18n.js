...
const dict = {
  ...
  IT: {
    ...
    upload: {
      ...
      aiDraftSubtitle: "La bozza generata dall'AI che hai ricevuto",
      finalTitle: "Testo finale",
      finalSubtitle: "La versione revisionata dall'editor",
      cta: "Carica .docx",
      uploaded: (n) => `Caricato · ${n} parole`,
    },
    parsing: { draft: "la bozza AI", final: "il testo finale", label: (which) => `Analisi di ${which} in corso…` },
    runCounter: {
    ...
    placeholder: { ready: "Clicca su «Verifica articolo»", notReady: "Carica entrambi i file e clicca su «Verifica articolo»" },
    exhaustedPanel: {
    ...
    errors: {
      ...
      noFile: "Nessun file è stato fornito",
      badFormat: "Sono supportati solo file .docx",
      ...
      fileTooLarge: "Il file è troppo grande. La dimensione massima è 2MB",

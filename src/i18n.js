...
const dict = {
  EN: {
    ...
    errors: {
      ...
      analyzeFailed: "Could not get a review from OpenAI",
  ...
  ES: {
    ...
    errors: {
      ...
      analyzeFailed: "No se pudo obtener una evaluación de OpenAI",
  ...
  BR: {
    ...
    errors: {
      ...
      analyzeFailed: "Não foi possível obter uma avaliação da OpenAI",
  ...
  DE: {
    ...
    errors: {
      ...
      analyzeFailed: "Es konnte keine Bewertung von OpenAI abgerufen werden",
  ...
  FR: {
    ...
    errors: {
      ...
      analyzeFailed: "Impossible d'obtenir une évaluation depuis OpenAI",
  ...
  TR: {
    ...
    errors: {
      ...
      analyzeFailed: "OpenAI'dan değerlendirme alınamadı",
  ...
  PL: {
    ...
    errors: {
      ...
      analyzeFailed: "Nie udało się uzyskać oceny z OpenAI",
  ...
  VN: {
    ...
    errors: {
      ...
      analyzeFailed: "Không thể nhận đánh giá từ OpenAI",
